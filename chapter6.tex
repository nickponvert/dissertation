...
% %
% We turned to the available literature on the role of sensory cortical regions during behavior to try and address the question
...
% 
% % NO: Check supplemental of ref 10 in Lan's paper (I think Petr). 
...
% 
% % MAYBE: Check out Brice B's paper showing that for simple stimuli the thalamic pathway takes over, but for complex stimuli the reaction times are longer and the cortical pathway seems required. 
% 
% 
